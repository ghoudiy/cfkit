...
def run_action():
  ...
  if args.problem_code is None:
    Problem(file).run_demo(file, args.order, args.formatting,args.remove, None, args.not_verbose)
  else:
    Problem(args.problem_code).run_demo(file, args.order, args.formatting, args.remove, None, args.not_verbose)
